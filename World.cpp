...
World::World(const std::string& worldFilePath) {
    ...
    while (stream.peek(), stream.good()) {
        ...
        Point center (x, y);        //создаем объект класса Point с координатами центра шара
        Point vector (vx, vy);      // создаем объект класса Point с координатами вектора скорости
        Velocity velocity (vector);  // создаем объект класса Velocity, в котором скорость будет задана в виде вектора
        Color color (red, green, blue); // создаем объект color класса Color с собранными определениями цветов
        //Color color (255, 255, 255); // создаем объект color класса Color с собранными определениями цветов

        Ball ball ( center,  velocity,  color,  radius); // конструируем объект ball класса Ball
        ...
        // debug
        //std::cout  << "ball object was created and added to container" << std::endl;
